...
public class MetrixMetricsStreamServlet extends HttpServlet {

	private static final long serialVersionUID = -4211832019818817096L;
	
    private static final Logger logger = LoggerFactory.getLogger(MetrixMetricsStreamServlet.class);
    ...
    private void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MetrixMetricsPoller poller = null;
        try {
            if (numberConnections > maxConcurrentConnections.get()) {
                ...
                poller = createMetricsPoller(delay, jsonListener);
	...
	protected MetrixMetricsPoller createMetricsPoller(int delay, MetricJsonListener jsonListener) {
		return new MetrixMetricsPoller(jsonListener, delay); 
	}
     ...
     * @ThreadSafe
     */
    private static class MetricJsonListener implements MetrixMetricsPoller.MetricsAsJsonPollerListener {
